...
def main() -> bool:
    '''
        Bootstraps and runs the gen_mqtt_service with required adapters.

        :return: True if successful, False otherwise.
        :exceptions: None
    '''
    gen_mqtt_service: GenMqttService = GenMqttService(GenMqttServiceBundleFactory.create_bundle())

    return gen_mqtt_service.process()


if __name__ == '__main__':
    '''
        Entry point for gen_mqtt_service execution.
