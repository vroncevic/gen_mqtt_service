...
Info
    Engine orchestrating the initialization and execution of gen_mqtt_service.
'''
...
class GenMqttService(Base):
    '''
        ...
        It defines:
            ...
            :attributes:
                | _is_initialized - The flag indicating whether the gen_mqtt_service engine is initialized.
            ...
            :methods:
                | __init__ - Initializes the gen_mqtt_service engine with adapters and services.
                | process - Processes the gen_mqtt_service commands.
    '''
    ...
    def __init__(self, bundle: GenMqttServiceBundle) -> None:
        '''
            Initializes the gen_mqtt_service engine with adapters and services.

            :param bundle: gen_mqtt_service bundle containing adapters and services.
            :exceptions: None.
        '''
        ...
        try:
            ...
            self._logger.write_log(INFO, '✅ gen_mqtt_service: engine initialized successfully!')

        except (ATSValueError, ATSTypeError) as exc:
            stdout.write(f'❌ gen_mqtt_service: {exc}!\n')
    ...
    def process(self, verbose: bool = False) -> bool:
        ...
        try:
            ...
            self._logger.write_log(ERROR, f'❌ gen_mqtt_service unexpected exception: {exc}!')
            return False
