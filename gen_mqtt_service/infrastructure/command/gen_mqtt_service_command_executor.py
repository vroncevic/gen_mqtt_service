...
Info
    Defines GenMqttServiceCommandExecutor class.
'''
...
class GenMqttServiceCommandExecutor:
    '''
        Command executor strategy for generating mqtt_service project files.
    ...
    def __str__(self) -> str:
        '''
            Returns the GenMqttServiceCommandExecutor as string representation.

            :return: The GenMqttServiceCommandExecutor as string representation.
        '''
        return to_str(self)
