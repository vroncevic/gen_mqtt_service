...
Info
    Defines GenMqttServiceCommandDefinition class.
'''
...
class GenMqttServiceCommandDefinition:
    '''
        CLI subcommand metadata definition for mqtt_service project generation.
    ...
    def help_text(self) -> str:
        ...
        '''
        return 'Generate MqttService project skeleton'
    ...
    def options(self) -> Sequence[OptionData]:
        ...
        return [
            OptionData(
                name="--name",
                help_text="mqtt_service project name",
                action=None,
                default="myapp",
                required=True,
                choices=None,
            ...
            OptionData(
                name="--type",
                help_text="project type (mosquitto, node, node_ws, paho)",
                action=None,
                default="paho",
                required=True,
                choices=["mosquitto", "node", "node_ws", "paho"],
                nargs=None
            ),
            OptionData(
                name="--output",
