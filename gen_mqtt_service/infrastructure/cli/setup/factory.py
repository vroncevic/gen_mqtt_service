...
from gen_mqtt_service.infrastructure.cli.setup.options import CLIBundleOptions
from gen_mqtt_service.infrastructure.cli.setup.opt_validator import CLIBundleOptionsValidator
from gen_mqtt_service.infrastructure.cli.setup.bundle import CLIBundle
from gen_mqtt_service.infrastructure.cli.setup.keys import CLIBundleKeys
...
from gen_mqtt_service.infrastructure.command.icommand_executor import ICommandExecutor
...
class CLIBundleFactory:
    ...
    def create_bundle(cls, options: CLIBundleOptions) -> CLIBundle:
        ...
        service_definition: ICommandDefinition = GenMqttServiceCommandDefinition()
        service_executor: ICommandExecutor = GenMqttServiceCommandExecutor(definition=service_definition)
