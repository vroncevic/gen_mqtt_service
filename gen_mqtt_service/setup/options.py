...
Info
    GenMqttService bundle options for the gen_mqtt_service bundle.
'''
...
class GenMqttServiceBundleOptions(TypedDict):
    '''
        GenMqttService bundle options for the gen_mqtt_service bundle.
        ...
        It defines:
            ...
            :attributes:
                | info_file - The info file path for the gen_mqtt_service bundle.
    '''
