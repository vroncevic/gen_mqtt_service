...
Info
    A validator for the gen_mqtt_service bundle.
'''
...
class GenMqttServiceBundleValidator:
    '''
        A validator for the gen_mqtt_service bundle.
    ...
    @classmethod
    def validate(cls, bundle: GenMqttServiceBundle) -> None:
        '''
            Validates the gen_mqtt_service bundle.

            :param bundle: The gen_mqtt_service bundle to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'gen_mqtt_service_bundle_validator::validate(...)'
        msg_bundle_none: str = 'the gen_mqtt_service bundle must be provided'
        msg_bundle_istype: str = 'the gen_mqtt_service bundle must be an instance of GenMqttServiceBundle'
        ...
        istype(bundle, GenMqttServiceBundle, ctx, msg_bundle_istype)
