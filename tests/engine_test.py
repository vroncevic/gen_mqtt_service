...
Module
    test_engine.py
Info
    Unit tests for GenMqttService engine.
'''
...
from gen_mqtt_service.engine import GenMqttService
...
class TestGenMqttService(unittest.TestCase):
    ...
    def test_engine_process_success(self) -> None:
        ...
        mock_base = BaseBundleFactory.create_bundle(
            options=BaseBundleOptions(
                info_file='gen_mqtt_service/infrastructure/config/gen_mqtt_service.cfg',
                use_generator=True,
    ...
    @patch('gen_mqtt_service.setup.validator.GenMqttServiceBundleValidator.validate')
    ...
    def test_cli_bundle_factory(self) -> None:
        from gen_mqtt_service.infrastructure.cli.setup.factory import CLIBundleFactory
