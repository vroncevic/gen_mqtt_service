...
Info
    Defines class GenMQTTServiceTestCase with attribute(s) and method(s).
    Creates test cases for checking functionalities of GenMQTTService.
Execute
    python3 -m unittest -v gen_mqtt_service_test
'''
...
class GenMQTTServiceTestCase(TestCase):
    '''
        Defines class GenMQTTServiceTestCase with attribute(s) and method(s).
        Creates test cases for checking functionalities of GenMQTTService.
        GenMQTTService unit tests.
    ...
    def test_default_create(self) -> None:
        ...
        generator: GenMQTTService = GenMQTTService()
    ...
    def test_missing_args(self) -> None:
        ...
        sys.argv.insert(1, 'gen_mqtt_service_run.py')
        generator: GenMQTTService = GenMQTTService()
