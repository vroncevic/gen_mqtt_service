...
Module
    registry_test.py
Info
    Unit tests for GenMqttServiceBundleRegistry class.
'''
...
class TestGenMqttServiceBundleRegistry(unittest.TestCase):
    ...
    def test_create_bundle_success(self) -> None:
        ...
        bundle = GenMqttServiceBundleRegistry.create_bundle(dependencies)
