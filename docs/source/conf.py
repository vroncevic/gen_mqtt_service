...
project: str = 'gen_mqtt_service'
project_copyright: str = '2024, Vladimir Roncevic <elektron.ronca@gmail.com>'
author: str = 'Vladimir Roncevic <elektron.ronca@gmail.com>'
version: str = '1.1.2'
release: str = 'https://github.com/vroncevic/gen_mqtt_service/releases'
...
htmlhelp_basename: str = 'gen_mqtt_servicedoc'
latex_elements: Dict[Any, Any] = {}
latex_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_mqtt_service.tex', 'gen_mqtt_service Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_mqtt_service', 'gen_mqtt_service Documentation',
    [author], 1
)]
texinfo_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_mqtt_service', 'gen_mqtt_service Documentation', author,
    'gen_mqtt_service', 'One line description of project.', 'Miscellaneous'
)]
